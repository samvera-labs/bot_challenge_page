module WebmockTurnstileHelperMethods
  ...
  def stub_turnstile_success(turnstile_response: {},
      request_body: {"secret"=>BotChallengePage::BotChallengePageController.cf_turnstile_secret_key, "response"=>"XXXX.DUMMY.TOKEN.XXXX", "remoteip"=>"0.0.0.0"})
    ...
    stub_request(:post, BotChallengePage::BotChallengePageController.cf_turnstile_validation_url).
         with(
